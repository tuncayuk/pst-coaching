...
const EXPECTED_ACS = [
  "AC-FR-E8-01-01","AC-FR-E8-01-02","AC-FR-E8-01-03","AC-FR-E8-01-04",
  "AC-FR-E8-02-01","AC-FR-E8-02-02","AC-FR-E8-02-03","AC-FR-E8-02-04",
  "AC-FR-E8-03-01","AC-FR-E8-03-02","AC-FR-E8-03-03","AC-FR-E8-03-04",
  "AC-FR-E8-04-01","AC-FR-E8-04-02","AC-FR-E8-04-03","AC-FR-E8-04-04",
  "AC-FR-E8-05-01","AC-FR-E8-05-02","AC-FR-E8-05-03","AC-FR-E8-05-04",
  "AC-FR-E8-06-01","AC-FR-E8-06-02","AC-FR-E8-06-03","AC-FR-E8-06-04",
  "AC-FR-E8-07-01","AC-FR-E8-07-02","AC-FR-E8-07-03","AC-FR-E8-07-04",
  "AC-FR-E8-08-01","AC-FR-E8-08-02","AC-FR-E8-08-03","AC-FR-E8-08-04",
];
...
const allScreenContent = SCREEN_FILES.map((f) => {
  try { return fs.readFileSync(path.join(SCREENS_DIR, f), "utf8"); } catch (_) { return ""; }
}).join("\n");
...
console.log(`FR/AC: ${acFound}/${EXPECTED_ACS.length} found${acMissing.length ? "  MISSING: " + acMissing.length : ""}`);
...
let asciiClean = 0; let asciiDirty = 0;
for (const filename of SCREEN_FILES) {
  ...
  if (nonAscii && nonAscii.length > 0) {
    console.warn(`  WARN ${filename}: ${nonAscii.length} non-ASCII chars (${[...new Set(nonAscii)].slice(0,10).join("")})`);
    asciiDirty++;
  } else {
    asciiClean++;
  }
