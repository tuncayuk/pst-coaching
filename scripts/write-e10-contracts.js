...
const CONTRACTS = [
  {
    ...
    uiStates: {
      ...
      ready: {
        description:
          'All toggles interactive: high contrast, reduce motion. Navigation to text-scale, theme, screen-reader sub-screens.'
      },
  ...
  },
  {
    ...
    uiStates: {
      ...
      ready: {
        description: 'Step selector (5 levels) with live preview paragraph. Save button persists choice.'
      },
  ...
  },
  {
    ...
    uiStates: {
      ...
      ready: {
        description: 'Theme radio group (Acik/Koyu/Sistem), high contrast toggle, color blindness mode chips.'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E10-04: Ekran okuyucu uyumu - etiket durumu, odak sirasi, form etiketleri, gorsel alternatifleri.',
    entryPoints: ['profile.accessibility', 'accessibility.fr_e10_01'],
    ...
    uiStates: {
      ...
      ready: {
        description: 'Feature checklist with status indicators. Tips and toggle for enhanced screen reader mode.'
      },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E10-04-01', 'AC-FR-E10-04-02', 'AC-FR-E10-04-03', 'AC-FR-E10-04-04'],
    gates: ['auth']
  }
];
