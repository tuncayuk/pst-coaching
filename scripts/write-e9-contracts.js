...
const CONTRACTS = [
  {
    ...
    analytics: { screenView: "favorites_viewed", events: ["favorites_viewed", "favorite_opened", "favorite_filter_applied"] },
  ...
  },
  {
    ...
    gates: ["auth", "subscription"],
    analytics: { screenView: "favorite_detail_viewed", events: ["favorite_detail_viewed", "favorite_note_saved", "favorite_source_opened"] },
  ...
  },
  {
    ...
    gates: ["auth", "subscription"],
    analytics: { screenView: "collections_viewed", events: ["collections_viewed", "collection_created", "collection_deleted", "collection_delete_undone"] },
  ...
  },
  {
    ...
    fr: "FR-E9-04",
    purpose: "Implements FR-E9-04: Favorilerde ve koleksiyonda arama (baslik/not/kaynak), icerik turu filtresi, filtre temizleme.",
    entryPoints: ["favorites.collections"],
    gates: ["auth", "subscription"],
    analytics: { screenView: "collection_detail_viewed", events: ["collection_detail_viewed", "favorites_searched", "favorites_filter_applied", "favorites_filter_cleared"] },
  ...
  },
  {
    ...
    gates: ["auth", "subscription"],
    analytics: { screenView: "favorites_export_viewed", events: ["favorites_export_viewed", "favorites_export_confirmed", "favorites_export_cancelled"] },
  ...
  },
  {
    ...
    fr: "FR-E9-06",
    purpose: "Implements FR-E9-06: Indirilen favorileri cevrimdisi goruntuleme, otomatik senkronizasyon, depolama uyarisi.",
    entryPoints: ["library.overview", "favorites.list"],
    gates: ["auth", "subscription"],
    analytics: { screenView: "downloads_viewed", events: ["downloads_viewed", "download_opened", "download_deleted", "download_sync_triggered"] },
