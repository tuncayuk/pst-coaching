...
const CONTRACTS = [
  ...
  },
  {
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Package description, objectives, section list with type badges, 'Paketi Basla' CTA.",
      },
  ...
  },
  {
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Lock icon, prerequisite package name, lock reason, countdown to 08:00 if BR-01 applies.",
      },
