...
const contracts = [
  {
    ...
    route: '/ebook/reader',
    purpose:
      'Implements FR-E7-01: Son okunan sayfa otomatik acilis, kitap basligı ve sayfa bilgisi, TOC erisim, cevrimdisi okuma.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Reader shows chapter title, page range, reading progress bar. Last-read chapter auto-opens (AC-FR-E7-01-01). Chapter title + current page / total pages visible (AC-FR-E7-01-02). TOC button in floating toolbar (AC-FR-E7-01-03). Offline badge when downloaded (AC-FR-E7-01-04).'
      },
    ...
    analytics: {
      ...
      events: [
        'ebook_reader_viewed',
        'ebook_chapter_opened',
        'ebook_toc_opened',
        'ebook_settings_opened',
        'ebook_highlight_created',
        'ebook_audio_started'
      ]
    },
  ...
  },
  {
    ...
    purpose:
      "Implements FR-E7-02: Kaydirma/sayfa cevirme, sayfa numarasina atlama, TOC'dan bolume atlama, ilerleme cubugu.",
    ...
    uiStates: {
      ...
      ready: {
        description:
          'TOC sheet lists all chapters. Tap to navigate (AC-FR-E7-02-03). Jump-to-page input available (AC-FR-E7-02-02). Progress bar at top (AC-FR-E7-02-04). Navigation between chapters supported (AC-FR-E7-02-01).'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E7-03: Font boyutu slider, arka plan rengi secimi (Beyaz/Sepia/Koyu), satir araligi, ayarlar saklama.',
    entryPoints: ['ebook.reader'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Font size slider (AC-FR-E7-03-01). Background: Beyaz/Sepia/Koyu chips (AC-FR-E7-03-02). Line height selector (AC-FR-E7-03-03). Preview text paragraph updates live. Settings auto-save (AC-FR-E7-03-04).'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E7-04: Metin seciminde renk secenekleri, not ekleme otomatik kaydetme (BR-12), vurgu favorilere ekleme.',
    entryPoints: ['ebook.reader'],
    inputs: [
      { name: 'ebookId', type: 'string', required: true, source: 'route_param' },
      { name: 'chapterId', type: 'string', required: false, source: 'route_param' }
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Color picker shows on (simulated) text selection (AC-FR-E7-04-01). Note field with auto-save (AC-FR-E7-04-02, BR-12). Add-to-favorites toggle (AC-FR-E7-04-03).'
      },
  ...
  },
  {
    ...
    inputs: [{ name: 'ebookId', type: 'string', required: true, source: 'route_param' }],
    dataDependencies: ['Highlight', 'Note', 'FavoriteItem'],
    uiStates: {
      loading: { description: 'Skeleton list items while loading highlights.' },
      ready: {
        description:
          'Color-coded highlight list per ebook (AC-FR-E7-05-01). Tap card navigates to reader at that chapter (AC-FR-E7-05-02). Note field editable (AC-FR-E7-05-03). Export (PDF/metin) with privacy consent (AC-FR-E7-05-04, BR-09). Add-to-favorites (AC-FR-E7-04-03).'
      },
  ...
  },
  {
    ...
    route: '/ebook/audio',
    purpose:
      'Implements FR-E7-06: Sesli versiyon Play butonu (varsa), metin senkron takip, hiz ayari, arka planda calisma.',
    entryPoints: ['ebook.reader'],
    inputs: [
      { name: 'ebookId', type: 'string', required: true, source: 'route_param' },
      { name: 'chapterId', type: 'string', required: false, source: 'route_param' }
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Play button visible when has_audio=true; hidden otherwise (AC-FR-E7-06-01). Current sentence/paragraph highlighted in sync (AC-FR-E7-06-02). Speed chips: 0.75x/1x/1.25x (AC-FR-E7-06-03). Background play session hint (AC-FR-E7-06-04).'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E7-07: Ilerleme yüzdesi, kalan süre tahmini, tamamlanma rozeti/sertifikasi, Gelisim paneli yansimasi.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Progress percentage (AC-FR-E7-07-01). Estimated remaining time (AC-FR-E7-07-02). Completion badge/certificate CTA when finished (AC-FR-E7-07-03). Progress reflected in ProgressDashboard (AC-FR-E7-07-04).'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E7-08: Indirme butonu detayda, indirme durumu (ilerleme/tamamlandi/hata), depolama uyarisi, gorsel isaretleme.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Download button in ebook detail (AC-FR-E7-08-01). Download progress/completed/error states shown (AC-FR-E7-08-02). Low storage warning (AC-FR-E7-08-03). Downloaded ebooks show checkmark (AC-FR-E7-08-04).'
      },
