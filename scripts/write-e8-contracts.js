...
const CONTRACTS = [
  {
    ...
    fr: "FR-E8-01",
    purpose: "Implements FR-E8-01: Atolye landing ekrani, baslik, tema, donusum hedefi, hedef kitle, sure, referanslar ve rol bazli CTA.",
    entryPoints: ["discover.workshops", "library.workshops"],
    gates: ["auth"],
    analytics: { screenView: "workshop_landing_viewed", events: ["workshop_landing_viewed", "workshop_started", "workshop_resumed"] },
  ...
  },
  {
    ...
    fr: "FR-E8-02",
    purpose: "Implements FR-E8-02: Asama listesi/zaman cizelgesi, tip bazli etiketler, kilit durumu ve Devam Et aksiyonu.",
    entryPoints: ["workshop.landing"],
    gates: ["auth"],
    analytics: { screenView: "workshop_phases_viewed", events: ["workshop_phases_viewed", "workshop_phase_tapped", "workshop_resumed"] },
  ...
  },
  {
    ...
    gates: ["auth"],
    analytics: { screenView: "workshop_section_viewed", events: ["workshop_section_viewed", "workshop_section_completed", "highlight_created", "note_saved"] },
  ...
  },
  {
    ...
    analytics: { screenView: "workshop_camp_viewed", events: ["workshop_camp_viewed", "workshop_session_started", "workshop_session_completed"] },
  ...
  },
  {
    ...
    gates: ["auth"],
    analytics: { screenView: "workshop_guide_viewed", events: ["workshop_guide_viewed", "facilitator_mode_toggled", "guide_section_jumped"] },
  ...
  },
  {
    ...
    fr: "FR-E8-06",
    purpose: "Implements FR-E8-06: Yapilandirilmis calisma kagitlari, otomatik kayit, devam et ve gizlilik onayi ile disari aktarim.",
    entryPoints: ["workshop.phases", "workshop.section"],
    gates: ["auth"],
    analytics: { screenView: "workshop_workbook_viewed", events: ["workshop_workbook_viewed", "workbook_entry_saved", "workbook_exported"] },
  ...
  },
  {
    ...
    fr: "FR-E8-07",
    purpose: "Implements FR-E8-07: 72 saatlik toparlanma, 3 haftalik takip, 30 gunluk plan, niyet/cumleler/adimlar ve hatirlatici.",
    entryPoints: ["workshop.completion", "workshop.phases"],
    gates: ["auth", "subscription"],
    analytics: { screenView: "workshop_followup_viewed", events: ["workshop_followup_viewed", "followup_plan_saved", "followup_reminder_set"] },
  ...
  },
  {
    ...
    gates: ["auth"],
    analytics: { screenView: "workshop_completion_viewed", events: ["workshop_completion_viewed", "workshop_completed", "certificate_shared"] },
...
for (const c of CONTRACTS) {
  const contract = {
    ...
    uiStates: {
      ...
      ready: { description: `${c.fr} flows fully interactive; primary CTA available when prerequisites met.` },
      empty: { description: "Empty state explains why no data is available and offers next best action." },
      error: { description: "Error state is recoverable with user-safe messaging and retry action." },
      offline: { description: "Offline state shows last synchronized data; write actions queued for later sync." },
    },
