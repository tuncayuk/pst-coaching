...
const uiStates = {
  ...
  empty: {
    description: 'Empty state explains why no data is available and points to next best action.'
  },
  error: {
    description: 'Error state is recoverable with user-safe messaging and a retry action.'
  },
  offline: {
    description: 'Offline state shows last synchronized data and queues write actions for later sync.'
  }
};
...
const contracts = [
  {
    ...
    analytics: {
      ...
      events: ['notification_list_viewed', 'notification_mark_read', 'notification_bulk_read', 'notification_cleared']
    },
    acceptanceCriteriaRefs: ['AC-FR-E17-01-01', 'AC-FR-E17-01-02', 'AC-FR-E17-01-03', 'AC-FR-E17-01-04']
  },
  {
    ...
    analytics: {
      ...
      events: ['notification_detail_viewed', 'notification_cta_tapped', 'notification_deep_linked']
    },
    acceptanceCriteriaRefs: ['AC-FR-E17-02-01', 'AC-FR-E17-02-02', 'AC-FR-E17-02-03', 'AC-FR-E17-02-04']
  },
  {
    ...
    acceptanceCriteriaRefs: ['AC-FR-E17-03-01', 'AC-FR-E17-03-02', 'AC-FR-E17-03-03', 'AC-FR-E17-03-04']
  },
  {
    id: 'notifications.fr_e17_04',
    title: 'Hatirlatici planlama ve tip bazli zamanlama',
    route: '/notifications/reminders',
    purpose: 'Implements FR-E17-04: Hatirlatici planlama ve tip bazli zamanlama.',
    entryPoints: ['profile.settings'],
    dataDependencies: ['ReminderSetting'],
    analytics: {
      screenView: 'reminder_planner_viewed',
      events: ['reminder_planner_viewed', 'reminder_time_added', 'reminder_time_removed', 'reminder_type_toggled']
    },
    acceptanceCriteriaRefs: ['AC-FR-E17-04-01', 'AC-FR-E17-04-02', 'AC-FR-E17-04-03', 'AC-FR-E17-04-04']
  }
];
