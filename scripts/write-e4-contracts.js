...
const contracts = [
  {
    ...
    route: '/discover',
    purpose:
      'Implements FR-E4-01: Content discovery hub with content-type tabs, assistant CTA, and featured content sections.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Tab bar, assistant CTA, featured journey cards and ebook row rendered. Active tab highlighted. Guest badge shown for unauthenticated users.'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E4-02: Step-by-step content assistant with 3 questions (goal, duration, preference) producing 1 primary + 2 alternative recommendations.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          "3-step form: goal radio, duration buttons, preference buttons. Progress pill shows X/3. 'Oneri Al' navigates to results. 'Atla' navigates to catalog."
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E4-03: Journey catalog with sort (Tumu/Onerilen/Populer/Yeni), level filter (Baslangic/Orta/Ileri), favorites toggle, and Yolculugu Baslat CTA.',
    entryPoints: ['discover.fr_e4_01'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Sort chips + level filter chips + journey cards. Card shows: title, duration, level, daily_target, content count chips (Modul/Atolye/Kitap), heart-favorites toggle, 'Yolculugu Baslat' CTA. Empty-filter state shown when filter yields 0 results."
      },
      empty: { description: 'Empty state with notification opt-in CTA.' },
      error: { description: 'Error state with retry action.' },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-03-01', 'AC-FR-E4-03-02', 'AC-FR-E4-03-03', 'AC-FR-E4-03-04'],
    gates: []
  },
  {
    ...
    purpose:
      'Implements FR-E4-04: Workshop catalog with sort, type filter (Kamp/Rehber/Calisma-Kitabi), showing tema, hedef kitle, sure, oturum sayisi, and type badges.',
    entryPoints: ['discover.fr_e4_01'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Sort chips + type filter chips + workshop cards. Card shows: title, duration, age target, session count, type badge (Kamp/Rehber/Calisma Kitabi), 'Detaylari Gor' button. Empty-filter state when filter yields 0."
      },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-04-01', 'AC-FR-E4-04-02', 'AC-FR-E4-04-03', 'AC-FR-E4-04-04'],
    gates: []
  },
  {
    ...
    purpose:
      'Implements FR-E4-05: Module catalog with sort, topic filter (Gelisim/Maneviyat/Denge), package count, preview package list with descriptions, and Modulu Baslat CTA.',
    entryPoints: ['discover.fr_e4_01'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Sort chips + topic filter chips + module cards. Card shows: title, description, package count chip, top-2 package preview with index badges and short descriptions, 'Modulu Baslat' CTA. Empty-filter state when filter yields 0."
      },
      empty: { description: 'Empty state with notification opt-in.' },
      error: { description: 'Error state with retry action.' },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-05-01', 'AC-FR-E4-05-02', 'AC-FR-E4-05-03', 'AC-FR-E4-05-04'],
    gates: []
  },
  {
    ...
    purpose:
      'Implements FR-E4-06: eBook catalog with sort, category filter, cover grid, page count + reading time, featured badge, and Okumaya Basla CTA in detail.',
    entryPoints: ['discover.fr_e4_01'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Sort chips + category filter chips + 2-column cover grid. Each item shows: colored cover, title, category, page/reading-time meta. Featured badge on featured items. Empty-filter state when filter yields 0.'
      },
      empty: { description: 'Empty state with notification opt-in.' },
      error: { description: 'Error state with retry action.' },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-06-01', 'AC-FR-E4-06-02', 'AC-FR-E4-06-03', 'AC-FR-E4-06-04'],
    gates: []
  },
  {
    ...
    purpose:
      'Implements FR-E4-07: Content launch gate sequence (Auth → Subscription → Add-on → Demographics → DDL), planning options, time rules, psychological safety notice, and activation.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          "Gate sequence evaluated. Planning options presented per content type. Time rules shown. Psychological safety notice (BR-11) shown. 'Basla' activates content."
      },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-07-01', 'AC-FR-E4-07-02', 'AC-FR-E4-07-03', 'AC-FR-E4-07-04', 'AC-FR-E4-07-05'],
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E4-08: Guest users can browse all catalog/detail screens. Free content tagged. Start actions redirect to registration. Post-registration free content unlocked.',
    entryPoints: ['bottom_tab.discover'],
    ...
    uiStates: {
      ...
      ready: {
        description:
          'Catalog visible. Free badge rendered on free items. Start/read taps redirect to registration flow.'
      },
    ...
    analytics: {
      ...
      events: ['discover_guest_viewed', 'discover_guest_start_tapped', 'discover_guest_registration_triggered']
    },
    acceptanceCriteriaRefs: ['AC-FR-E4-08-01', 'AC-FR-E4-08-02', 'AC-FR-E4-08-03', 'AC-FR-E4-08-04'],
    gates: []
  },
  {
    ...
    purpose:
      'Implements FR-E4-09: Demographics gate referenced from all content types, delegating to FR-E1-08 (BR-06). No independent demographic rule defined here.',
    entryPoints: ['discover.fr_e4_03', 'discover.fr_e4_04', 'discover.fr_e4_05', 'discover.fr_e4_06'],
    dataDependencies: ['UserProfile'],
    uiStates: {
      loading: { description: 'Checking demographics completion status.' },
      ready: {
        description: 'Delegates to FR-E1-08 demographics screen. No additional UI beyond gate check.'
      },
  ...
  },
  {
    ...
    purpose:
      'Implements FR-E4-10: DDL test gate on first journey start. Test required before launch. Results saved to profile. Not repeated if previously completed.',
    ...
    uiStates: {
      ...
      ready: {
        description:
          'DDL test presented. Journey blocked until test completed. If previously completed, gate passes immediately.'
      },
      empty: { description: 'Not applicable.' },
    ...
    acceptanceCriteriaRefs: ['AC-FR-E4-10-01', 'AC-FR-E4-10-02', 'AC-FR-E4-10-03', 'AC-FR-E4-10-04', 'AC-FR-E4-10-05'],
    gates: ['ddl_test']
  }
];
