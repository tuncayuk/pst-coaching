const PII_KEY_PATTERN =
  /^(email|e-mail|phone|mobile|first_name|last_name|full_name|name|address|street|city|state|zip|postal|dob|birth|birthday|password|token|session|ssn|user_id|userid|user)$/i;
