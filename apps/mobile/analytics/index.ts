...
import { screenViewEventName, ctaTapEventName } from "./events";
...
export const trackScreenView = (screenId: string) =>
  trackEvent(screenViewEventName(screenId), { screen_id: screenId });

export const trackCtaTap = (
  screenId: string,
  ctaId: string,
