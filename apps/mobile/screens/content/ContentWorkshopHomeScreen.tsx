    ...
    <>
      ...
      <SectionCard title={'Kaldgin Yerden Devam Et'}>
        ...
        <PButton
          ...
          onPress={() => handleNavigateSection(completedCount + 1 <= totalStages ? completedCount + 1 : 1)}
              ...
              <View style={styles.stageItem}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor: isCompleted ? '#4CAF50' : isLocked ? '#9E9E9E' : stageInfo.color
                    }
                  ]}
                >
                ...
                <View style={styles.stageBody}>
                  ...
                  {isCompleted ? (
                    <PText variant="labelSmall" style={styles.completedNote}>
                      Tamamlandi
                    </PText>
                  ) : null}
...
export const ContentWorkshopHomeScreen = ({ route }: { route?: { params?: RouteParams } }) => {
