...
const styles = StyleSheet.create({
  ...
  stepBtn: { width: 48, height: 48, borderRadius: 24, borderWidth: 1, borderColor: "#6B46C1", justifyContent: "center", alignItems: "center" },
  stepBtnDisabled: { borderColor: "#E5E7EB", opacity: 0.4 },
  stepBtnLabel: { fontSize: 14, fontWeight: "700", color: "#6B46C1" },
  stepValue: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: "#EDE7F6", borderRadius: 10 },
