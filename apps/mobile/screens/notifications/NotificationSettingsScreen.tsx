  ...
  return (
    ...
    >
      ...
      <SectionCard title="Sessiz Saatler">
        <PListItem
          ...
          right={() => (
            <PSwitch
              value={quietEnabled}
              onValueChange={(v) => { if (!isOffline) setQuietEnabled(v); }}
              disabled={isOffline}
                ...
                <View style={styles.timeChipRow}>
                  {QUIET_HOURS.map((t) => (
                    <View
                      ...
                      style={[
                        styles.timeChip,
                        quietStart === t && styles.timeChipSelected,
                      ]}
                      accessible
                    ...
                    >
                      <PText
                        style={[
                          styles.timeChipText,
                          quietStart === t && styles.timeChipTextSelected,
                        ]}
                ...
                <View style={styles.timeChipRow}>
                  {["06:00", "07:00", "08:00", "09:00", "10:00"].map((t) => (
                    <View
                      ...
                      style={[
                        styles.timeChip,
                        quietEnd === t && styles.timeChipSelected,
                      ]}
                      accessible
                      accessibilityRole="button"
                    ...
                    >
                      <PText
                        style={[
                          styles.timeChipText,
                          quietEnd === t && styles.timeChipTextSelected,
                        ]}
      ...
      <SectionCard title="Bildirim Sikligi">
        <PRadioButtonGroup
          value={frequency}
          onValueChange={(v) => { if (!isOffline) setFrequency(v as Frequency); }}
        >
      ...
      <SectionCard title="Ses ve Titresim">
        <PListItem
          ...
          right={() => (
            <PSwitch
              value={soundEnabled}
              onValueChange={(v) => { if (!isOffline) setSoundEnabled(v); }}
              disabled={isOffline}
        ...
        <PListItem
          ...
          right={() => (
            <PSwitch
              ...
              onValueChange={(v) => { if (!isOffline) setVibrationEnabled(v); }}
              disabled={isOffline}
    ...
    return (
      <ScreenLayout title="Bildirim Ayarlari">
        <StateMessage
          ...
          description="Bildirim ayarlari henuz olusturulmamis."
        />
      </ScreenLayout>
    );
  }
