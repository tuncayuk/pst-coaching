      ...
      <SectionCard title="Haftalik Analiz">
        <View style={styles.trendCard}>
          ...
          <View style={styles.trendInfo}>
            ...
            <PText style={styles.trendBody}>Carsamba gunu 3 seans ile en verimli gunun. Oglen saatlerinde odagin yuuksek.</PText>
          </View>
        </View>
        <View style={[styles.trendCard, styles.trendChallenge]}>
          ...
          <View style={styles.trendInfo}>
            ...
            <PText style={styles.trendBody}>Persembe gunleri eksik kaliyor. Kisa bir hatirlatici planlamayi dene.</PText>
          </View>
        </View>
