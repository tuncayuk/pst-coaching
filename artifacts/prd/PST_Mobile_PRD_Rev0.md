...
| EPIC 2 | Faz 1 | Danışan | US-2.9 Son Görüntülenen İçerikler | Danışan olarak, giriş yaptıktan sonra ana sayfada en son baktığım içerikleri görmek istiyorum, böylece hızlıca devam edebileyim. | • Son görüntülenen içerikler en fazla 5 kart olarak listelenir<br>• İçerikler tür etiketiyle gösterilir (yolculuk/atölye/modül/e-kitap)<br>• Kartta son görüntülenme zamanı ve kaldığım bölüm görünür<br>• Analytics event'leri: recent_content_viewed, recent_content_item_clicked<br>• Boş durumda önerilen içerikler gösterilir | Giriş → Ana Sayfa → Son Görüntülenenler |
...
| EPIC 4 | Faz 1 | Danışan | US-4.13 Yolculuğa Başlamadan Önce Demografi | Danışan olarak, yeni bir yolculuğa başlamadan önce yaş/cinsiyet/ülke bilgilerimin sorulmasını istiyorum. | • Yolculuğu Başlat CTA'sında demografi bilgisi yoksa form açılır<br>• Form kaydedilmeden yolculuk başlatılmaz<br>• "Bu bir terapi egitimi degildir, gerektiginde lutfen profesyonel bir yardim alin" bilgilendirmesi baslamadan once gosterilir<br>• Kaydedildikten sonra yolculuk otomatik başlar<br>• Daha önce kaydedilmişse akış atlanır | Yolculuk Detayı → Başlat → Demografi Formu → İçerik |
| EPIC 4 | Faz 1 | Danışan | US-4.14 Modüle Başlamadan Önce Demografi | Danışan olarak, yeni bir modüle başlamadan önce yaş/cinsiyet/ülke bilgilerimin sorulmasını istiyorum. | • Modülü Başlat CTA'sında demografi bilgisi yoksa form açılır<br>• Form kaydedilmeden modül başlatılmaz<br>• "Bu bir terapi egitimi degildir, gerektiginde lutfen profesyonel bir yardim alin" bilgilendirmesi baslamadan once gosterilir<br>• Kaydedildikten sonra modül otomatik başlar<br>• Daha önce kaydedilmişse akış atlanır | Modül Detayı → Başlat → Demografi Formu → İçerik |
...
| EPIC 4 | Faz 1 | Danışan | US-4.16 Atölyeye Başlamadan Önce Demografi | Danışan olarak, yeni bir atölyeye başlamadan önce yaş/cinsiyet/ülke bilgilerimin sorulmasını istiyorum. | • Atölyeyi Başlat CTA'sında demografi bilgisi yoksa form açılır<br>• Form kaydedilmeden atölye başlatılmaz<br>• "Bu bir terapi egitimi degildir, gerektiginde lutfen profesyonel bir yardim alin" bilgilendirmesi baslamadan once gosterilir<br>• Kaydedildikten sonra atölye otomatik başlar<br>• Daha önce kaydedilmişse akış atlanır | Atölye Detayı → Başlat → Demografi Formu → İçerik |
