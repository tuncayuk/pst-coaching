...
- Files touched: `artifacts/impl/app_shell/App.tsx`, `artifacts/impl/app_shell/screens/*`.
...
- Objective: Wire stack routes for home.search, home.search_results, home.vicdandan_karaktere_detail, home.active_content_list, plus discover.assistant_* and discover.* list screens, implementing production-ready UIs from screen contracts.
...
- Objective: Implement library.* and progress.* routes, add entitlement gate hook and paywall fallback route (content.paywall), and implement production-ready UIs from screen contracts.
